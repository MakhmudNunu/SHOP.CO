...
import { fetchCart, addCart } from '../../store/cartSlice/cartSlice';
import "./Cart.scss"
          ...
          <div key={item.id} className={`cart__content__main__items__item ${index === 0 ? "first" : index === cart.length - 1 ? "last" : "middle"}`}>
            ...
            <div className="cart__content__main__items__item__control">
              ...
              <div className="cart__content__main__items__item__control__count">
                <button onClick={() => itemMinus(item.id)} className="cart__content__main__items__item__control__minus">
                ...
                <p>{item.quantity}</p>
                <button onClick={() => itemPlus(item.id)} className="cart__content__main__items__item__control__plus">
